...
> `iam.disableServiceAccountKeyCreation` المفعّلة افتراضياً على المؤسسات
> الحديثة في Google Cloud) عبر Workload Identity Federation. خطوة التفعيل
> (نسخ ملف + سرّان في GitHub):
