...
""".trimIndent()
    ...
    // Dusk Indigo accent palette — course color coding
    private const val INDIGO_A = 0xFF5B62D6
    private const val VIOLET_A = 0xFF8B5CF6
    private const val TEAL_A = 0xFF2E9E8F
    private const val TEAL_DEEP_A = 0xFF1F7A6E
    private const val GOLD = 0xFFE8A23D
    private const val ROSE_A = 0xFFD66060
    private const val GREEN = 0xFF2FA36B

    val courses = listOf(
        // ===== المستوى الأول =====
        Course(1, 1, "من الصفر", CourseType.VOCABULARY, 25, INDIGO_A, LessonStyle.VOCAB_CARDS, "l1_scratch", "zero_to_hero"),
        Course(2, 1, "القواعد", CourseType.GRAMMAR, 24, VIOLET_A, LessonStyle.GRAMMAR_RULES, "l1_grammar", "grammar_l1"),
        Course(3, 1, "القراءة", CourseType.READING, 17, TEAL_A, LessonStyle.READING_TEXT, "l1_reading", "reading_l1"),
        Course(4, 1, "الاستماع", CourseType.LISTENING, 14, TEAL_DEEP_A, LessonStyle.LISTENING_AUDIO, "l1_listening", "listening_l1"),
        Course(5, 1, "المحادثة", CourseType.CONVERSATION, 8, ROSE_A, LessonStyle.CONVERSATION, "l1_conversation", "conversation_l1"),
        ...
        // ===== المستوى الثاني =====
        Course(8, 2, "Bites", CourseType.VOCABULARY, 30, INDIGO_A, LessonStyle.VOCAB_CARDS, "l2_bites", "bites"),
        Course(9, 2, "شفرة أمريكا", CourseType.READING, 10, GOLD, LessonStyle.CULTURE, "l2_americacode", "america_code"),
        Course(10, 2, "المحادثة", CourseType.CONVERSATION, 17, ROSE_A, LessonStyle.CONVERSATION, "l2_conversation", "conversation_l2"),
        Course(11, 2, "الاستماع", CourseType.LISTENING, 7, TEAL_DEEP_A, LessonStyle.LISTENING_AUDIO, "l2_listening", "listening_l2"),
        Course(12, 2, "التفكير", CourseType.READING, 12, TEAL_A, LessonStyle.THINKING, "l2_thinking", "thinking"),
        Course(13, 2, "الأخبار", CourseType.READING, 6, VIOLET_A, LessonStyle.NEWS, "l2_news", "news"),
        ...
        Course(16, 2, "القراءة", CourseType.READING, 8, TEAL_A, LessonStyle.READING_TEXT, "l2_reading", "reading_l2"),
        Course(17, 2, "الغرب", CourseType.READING, 8, VIOLET_A, LessonStyle.CULTURE, "l2_west", "the_west"),
        Course(18, 2, "القواعد", CourseType.GRAMMAR, 15, VIOLET_A, LessonStyle.GRAMMAR_RULES, "l2_grammar", "grammar_l2"),
        Course(19, 2, "كوميدي", CourseType.LISTENING, 16, ROSE_A, LessonStyle.COMEDY, "l2_comedy", "comedy"),
        Course(20, 2, "Story", CourseType.READING, 9, INDIGO_A, LessonStyle.STORY, "l2_story", "story"),

        // ===== المستوى الثالث =====
        Course(21, 3, "Idioms Podium", CourseType.VOCABULARY, 21, INDIGO_A, LessonStyle.IDIOMS, "l3_idioms", "idioms_podium"),
        Course(22, 3, "I Know", CourseType.READING, 23, TEAL_A, LessonStyle.READING_TEXT, "l3_iknow", "i_know"),
        Course(23, 3, "Coffee Break", CourseType.CONVERSATION, 2, ROSE_A, LessonStyle.CONVERSATION, "l3_coffeebreak", "coffee_break"),
        Course(24, 3, "IELTS", CourseType.GRAMMAR, 6, TEAL_DEEP_A, LessonStyle.EXAM_PREP, "l3_ielts", "ielts"),
