...
object CloudAuth {
    ...
    /**
     * Set from Settings once the learner pastes the Web Client ID generated by
     * Firebase after enabling Google as a sign-in provider. Empty by default —
     * Google Sign-In stays hidden in the UI until this is non-blank.
     */
